...
* `/visuals`: Prints da matriz de decisão e linha do tempo de jornada.
* `/metrics`: Lógica de classificação de causas raiz.
* `/documentation`: Discovery de negócios e mapeamento de dores do cliente.
* `/results`: Relatórios de melhoria de CSAT/NPS.
